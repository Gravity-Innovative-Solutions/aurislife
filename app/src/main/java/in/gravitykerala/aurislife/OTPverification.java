...
//        messageText.setGravity(Gravity.CENTER);
    ...
    public void sendotp() {

        {
            ...
            AzureMobileService.client.invokeApi("OTPRetrieval", String.class, new ApiOperationCallback<String>() {
                @Override
    ...
    public void newOTP() {
        ...
        AzureMobileService.client.invokeApi("OTPVerification?Password=" + tv.getText().toString(), String.class, new ApiOperationCallback<String>() {
            @Override
            public void onCompleted(String result, Exception exception, ServiceFilterResponse response) {
                if (exception == null) {
                    Toast.makeText(OTPverification.this, result, Toast.LENGTH_LONG).show();
